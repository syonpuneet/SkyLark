...
public class AccountActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        if (cd.isConnectingToInternet()) {
            ...
            if (Constant.isFileAvailable("getUserDetail" + mPref.getString(Constant.user_id, ""))) {

                progressBar.setVisibility(View.VISIBLE);
                component_layout.setVisibility(View.GONE);
                GetProfileinformationFromSdCard();
    ...
    private void GetProfileinformation() {
        new AsyncTask<Void, Integer, String>() {
            ...
            protected String doInBackground(Void... params) {
               ...
               // Constant.writtenToFile("getUserDetail" + mPref.getString(Constant.user_id, ""), encrypted, false);
    ...
    private void GetProfileinformationFromSdCard() {
        new AsyncTask<Void, Integer, String>() {
            ...
            protected String doInBackground(Void... params) {
                ...
                String encryptString = Constant.getStringFromFile("getUserDetail" + mPref.getString(Constant.user_id, ""));
    ...
    private void updateCartCounter() {
        new AsyncTask<Void, Integer, String>() {
            ...
            protected void onPostExecute(String res) {
               ...
               // String encrypted = Constant.encryptString(res);
