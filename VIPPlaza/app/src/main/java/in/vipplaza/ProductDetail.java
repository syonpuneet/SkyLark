...
public class ProductDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        options = new DisplayImageOptions.Builder()
                .showImageOnLoading(R.drawable.loading_productdetail)
                .showImageForEmptyUri(R.drawable.loading_productdetail)
                .showImageOnFail(R.drawable.loading_productdetail).cacheInMemory(true)
    ...
    private void initalizevariable() {
        ...
        if (cd.isConnectingToInternet()) {
            ...
            if (Constant.isFileAvailable("productDetail" + product_id)) {
                progressDialog.show();
                ProductDetailFromSdCard();
            } else {
        ...
        new AsyncTask<Void, Integer, String>() {
            ...
            protected String doInBackground(Void... params) {
              ...
              //  String encrypted = Constant.encryptString(result);
               ...
               // Constant.writtenToFile("productDetail" + product_id, encrypted, false);
                return result;
            }
    ...
    private void ProductDetailFromSdCard() {
        new AsyncTask<Void, Integer, String>() {
            ...
            protected String doInBackground(Void... params) {
                ...
                String encryptString = Constant.getStringFromFile("productDetail" + product_id);
    ...
    private void setData() {
        ...
        pager.setOnPageChangeListener(new ViewPager.OnPageChangeListener()
        {
            ...
            {
                Log.e("onPageSelected", "onPageSelected position..."+position);
            ...
            {
                Log.e("onPageScrollState", "onPageScrollStateChanged state..."+state);

                int index = pager.getCurrentItem();
                if (state ==ViewPager.SCROLL_STATE_IDLE)
                {
                    if ( index == (images.length-1) && isLast==true)
                    {
                    ...
                    {
                        pager.setCurrentItem(images.length-1 , true);
                    }
                }

                if((index == 0 && state ==ViewPager.SCROLL_STATE_DRAGGING))
                {
                    isFirst=true;
                }

                if((index == (images.length-1) && state ==ViewPager.SCROLL_STATE_DRAGGING))
                {
                    isLast=true;
                }
            }
