   ...
   // private int pageCount = 0;
    ...
    private void initalizevariable() {
        ...
        if (cd.isConnectingToInternet()) {
            ...
            if (Constant.isFileAvailable("catProducts" + cat_id)) {
...
//        });
    ...
    private void ProdutListing() {
        new AsyncTask<Void, Integer, String>() {
            ...
            protected String doInBackground(Void... params) {
             ...
             //   Constant.writtenToFile("catProducts" + cat_id, encrypted, false);
    ...
    private void ProdutListingFromSdCard() {
        new AsyncTask<Void, Integer, String>() {
            ...
            @Override
            protected String doInBackground(Void... params) {
                String encryptString = Constant.getStringFromFile("catProducts" + cat_id);
    ...
    private void setData(String result) {
        ...
        try {
            ...
            total_product.setText(objJson.getString("totalcount")
                    .toString() + " " + getString(R.string.txt_product_tag));
            if (status == 1) {
...
//                }
    ...
    private void setDateData() {
        ...
        long current_time = cal.getTimeInMillis()+(7*60*60*1000);
