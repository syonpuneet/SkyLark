...
public class HomeListAdapter extends ArrayAdapter<InfoHomeEvents> {
    ...
    public HomeListAdapter(Context act, int resource,
        ...
        options = new DisplayImageOptions.Builder()
                .showImageOnLoading(R.drawable.loading_brands)
                .showImageForEmptyUri(R.drawable.loading_brands)
                .showImageOnFail(R.drawable.loading_brands).cacheInMemory(true)
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        long end_time=Long.parseLong(info.get(position).event_start)*1000;
