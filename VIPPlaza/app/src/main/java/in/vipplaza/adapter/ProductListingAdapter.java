...
public class ProductListingAdapter extends ArrayAdapter<InfoProductListing> {
    ...
    public ProductListingAdapter(Context act, int resource,
        ...
        options = new DisplayImageOptions.Builder()
                .showImageOnLoading(R.drawable.loading_product_catalogue)
                .showImageForEmptyUri(R.drawable.loading_product_catalogue)
                .showImageOnFail(R.drawable.loading_product_catalogue).cacheInMemory(true)
